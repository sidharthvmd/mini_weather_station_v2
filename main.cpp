...
const char* ssid = "KrishnaKripa";
const char* password = "9746120591";
...
<body>
  ...
  <p>
    ...
    <span class="dht-labels">How it feels like</span> 
...
void setup(){
  ...
  server.on("/heat_index", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send_P(200, "text/plain", String(hi).c_str());
  });
